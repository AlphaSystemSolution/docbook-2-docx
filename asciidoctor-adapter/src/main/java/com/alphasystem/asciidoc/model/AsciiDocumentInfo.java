...
public class AsciiDocumentInfo {
  ...
  private static boolean getFailSafeBoolean(Map<String, Object> attributes, String key) {
    ...
    return value != null
        && (value.toString().trim().isBlank()
            || Boolean.parseBoolean(value.toString().trim().toLowerCase()));
  }
  ...
  public void setDocumentTitle(String documentTitle) {
    documentInfo.setDocumentTitle(
        getFailSafeString(documentTitle, documentInfo.getDocumentTitle()));
  }
  ...
  public void setCustomStyleSheetFile(File customStyleSheetFile) {
    final var value =
        customStyleSheetFile == null
            ? documentInfo.getCustomStyleSheetFile()
  ...
  public void setLastUpdateLabel(String lastUpdateLabel) {
    documentInfo.setLastUpdateLabel(
        getFailSafeString(lastUpdateLabel, documentInfo.getLastUpdateLabel()));
  }
  ...
  public void setTocPlacement(String tocPlacement) {
    ...
    attributes.setTableOfContents(
        (isBlank(value) || value.equals("auto"))
            ? Placement.LEFT
  ...
  public void setAppendixCaption(String appendixCaption) {
    documentInfo.setAppendixCaption(
        getFailSafeString(appendixCaption, documentInfo.getAppendixCaption()));
  }

  public void setCautionCaption(String cautionCaption) {
    documentInfo.setCautionCaption(
        getFailSafeString(cautionCaption, documentInfo.getCautionCaption()));
  }

  public void setExampleCaption(String exampleCaption) {
    documentInfo.setExampleCaption(
        getFailSafeString(exampleCaption, documentInfo.getExampleCaption()));
  }

  public void setFigureCaption(String figureCaption) {
    documentInfo.setFigureCaption(
        getFailSafeString(figureCaption, documentInfo.getFigureCaption()));
  }

  public void setImportantCaption(String importantCaption) {
    documentInfo.setImportantCaption(
        getFailSafeString(importantCaption, documentInfo.getImportantCaption()));
  }
  ...
  public void setWarningCaption(String warningCaption) {
    documentInfo.setWarningCaption(
        getFailSafeString(warningCaption, documentInfo.getWarningCaption()));
  }
  ...
  public void populateAttributes(Map<String, Object> attributes) {
    ...
    if (s != null) {
      File parent =
          new File(documentInfo.getSrcFile().getAbsoluteFile(), documentInfo.getStylesDir());
  ...
  public String toString() {
    return "AsciiDocumentInfo{"
        ...
        + '\''
        + ", backend='"
        + documentInfo.getBackend()
        + '\''
        + ", stylesDir='"
        + documentInfo.getStylesDir()
        + '\''
        + ", customStyleSheetFile="
        + documentInfo.getCustomStyleSheetFile()
        + ", linkCss="
        + documentInfo.isLinkCss()
        + ", includeDir='"
        + documentInfo.getIncludeDir()
        + '\''
        + ", docInfoDir='"
        + documentInfo.getDocInfoDir()
        + '\''
        + ", imagesDir='"
        + documentInfo.getImagesDir()
        + '\''
        + ", iconsDir='"
        + documentInfo.getIconsDir()
        + '\''
        + ", icons='"
        + documentInfo.getIcons()
        + '\''
        + ", iconFontName='"
        + documentInfo.getIconFontName()
        + '\''
        + ", idPrefix='"
        + documentInfo.getIdPrefix()
        + '\''
        + ", idSeparator='"
        + documentInfo.getIdSeparator()
        + '\''
        + ", docInfo='"
        + documentInfo.getDocInfo()
        + '\''
        + ", docInfo2="
        + documentInfo.isDocInfo2()
        + ", sourceLanguage='"
        + documentInfo.getSourceLanguage()
        + '\''
        + ", lastUpdateLabel='"
        + documentInfo.getLastUpdateLabel()
        + '\''
        + ", omitLastUpdatedTimeStamp="
        + documentInfo.isOmitLastUpdatedTimeStamp()
        + ", compact="
        + documentInfo.isCompact()
        + ", experimental="
        + documentInfo.isExperimental()
        + ", toc="
        + documentInfo.isToc()
        + ", tocClass='"
        + documentInfo.getTocClass()
        + '\''
        + ", tocPlacement='"
        + documentInfo.getTocPlacement()
        + '\''
        + ", tocPosition='"
        + documentInfo.getTocPosition()
        + '\''
        + ", tocTitle='"
        + documentInfo.getTocTitle()
        + '\''
        + ", appendixCaption='"
        + documentInfo.getAppendixCaption()
        + '\''
        + ", cautionCaption='"
        + documentInfo.getCautionCaption()
        + '\''
        + ", exampleCaption='"
        + documentInfo.getExampleCaption()
        + '\''
        + ", figureCaption='"
        + documentInfo.getFigureCaption()
        + '\''
        + ", importantCaption='"
        + documentInfo.getImportantCaption()
        + '\''
        + ", noteCaption='"
        + documentInfo.getNoteCaption()
        + '\''
        + ", tableCaption='"
        + documentInfo.getTableCaption()
        + '\''
        + ", tipCaption='"
        + documentInfo.getTipCaption()
        + '\''
        + ", untitledLabel='"
        + documentInfo.getUntitledLabel()
        + '\''
        + ", versionLabel='"
        + documentInfo.getVersionLabel()
        + '\''
        + ", warningCaption='"
        + documentInfo.getWarningCaption()
        + '\''
        + ", sectionNumbers="
        + documentInfo.isSectionNumbers()
        + ", hideUriSchema="
        + documentInfo.isHideUriSchema()
        + ", srcFile="
        + documentInfo.getSrcFile()
        + '}';
  }
}
